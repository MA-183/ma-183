...
(async () => {
    ...
    const filePath = path.resolve(process.cwd(), 'public/Ukesoppdrag-og-forelesningsnotat/Forelesningsnotat/Forelesning.12.11.html');
  ...
  // Inject CSS to hide the header
    ...
    const outputPath = path.resolve(process.cwd(), 'C:\\Users\\andrem\\OneDrive - Universitetet i Agder\\Undervisning\\MA-183\\2024\\Forelesning.12.11.pdf');
