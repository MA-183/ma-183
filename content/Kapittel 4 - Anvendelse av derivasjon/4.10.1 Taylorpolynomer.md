...
Vi har sett at den deriverte til $f$ i et punkt $c$ kan gi oss en [[Kapittel 4 - Anvendelse av derivasjon/defogteo/Def 4.9.8 Lineær approksimasjon|lineær approksimasjon]] nær $c$. Vi kan tilnærme en deriverbar funksjon $f$ rundt et punkt $a$ med tangenten til $f$ som går gjennom $f(a)$, nemlig
$$
