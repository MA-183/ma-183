...
> > $$
> > og vi har resultatet vi ønsker. Merk at vi bruker [[Kapittel 0 - innledende kapittel/7.4 Viktige identiteter|sammenhengen]] $\cos^2(x)+\sin^2(x) =1$, markert i oransje.
