...
> $$
> 
> Vi skal nå bruke noen [[Kapittel 1 - grenser og kontinuitet/defogteo/Teo Grenseverdiregler|grenseverdiregler]] til å si noe om grensen av høyre siden av likningen over når $h \longrightarrow  0$.
...
> \end{aligned} 
> $$
> Merk at grønn er [[Kapittel 1 - grenser og kontinuitet/defogteo/Teo Grenseverdiregler|punkt 1]] kombinert med 2. over. At $\lim{\color{#40c057} \text{grønn} } \cdot {\color{#e599f7} \text{rosa} } = {\color{#40c057} \text{grønn} } \cdot {\color{#e599f7} \text{rosa} }$ er [[Kapittel 1 - grenser og kontinuitet/defogteo/Teo Grenseverdiregler|punkt 3]] kombinert med 1. over.
